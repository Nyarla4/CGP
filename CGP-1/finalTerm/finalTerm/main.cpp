...
bool GraphicsClass::Frame()
{
	...
	D3DXVECTOR3 c_up(0.0f, 1.0f, 0.0f), c_position(0.0f, 0.0f, -10.0f), c_lookAt(0.0f, 0.0f, 1.0f);
	...
	m_worldMatrix = rotate * rotateY ;
	m_worldMatrix_ = rotateX;
	...
	result = RenderShader(m_worldMatrix_, m_viewMatrix, m_projectionMatrix);
	if (!result)
	{
		return false;
	}
