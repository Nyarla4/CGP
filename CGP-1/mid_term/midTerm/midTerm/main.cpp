...
bool GraphicsClass::Frame()
{
	...
	//m_Camera->render
	D3DXVECTOR3 up(0.0f, 1.0f, 0.0f), position(0.0f, 0.0f, -10.0f), lookAt(0.0f, 0.0f, 1.0f);
	float yaw(0.0f * 0.0174532925f), pitch(0.0f * 0.0174532925f), roll(0.0f * 0.0174532925f);
	...
	D3DXMatrixLookAtLH(&m_viewMatrix, &position, &lookAt, &up);//위에서 한 결과로 뷰매트릭스를 만들어 준다
